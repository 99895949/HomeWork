...
CREATE TABLE `cus_dev_plan` (
  ...
  CONSTRAINT `cus_dev_plan_ibfk_1` FOREIGN KEY (`saleChanceId`) REFERENCES `sale_chance` (`id`)
...
CREATE TABLE `organization` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='组织机构';
...
CREATE TABLE `resource` (
  ...
  `createdate` datetime DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=282 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='资源';
...
CREATE TABLE `role` (
  ...
  `status` tinyint(2) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='角色';
...
CREATE TABLE `role_resource` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=3758 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='角色资源';
...
INSERT INTO `syslog` VALUES ('735', 'admin', '客户流失管理', 'SystemManage.Customer.controller.CustomerLossController', '/customerLoss/manager', '', '0:0:0:0:0:0:0:1', '2020-02-20 11:34:50');
INSERT INTO `syslog` VALUES ('736', 'admin', '销售机会信息查看', 'SystemManage.SaleChance.controller.SaleChanceController', '/saleChances/manager', '', '0:0:0:0:0:0:0:1', '2020-02-20 11:35:38');
INSERT INTO `syslog` VALUES ('737', 'admin', '用户信息查看', 'SystemManage.UserManage.controller.UserController', '/user/manager', '', '0:0:0:0:0:0:0:1', '2020-02-20 11:35:50');
INSERT INTO `syslog` VALUES ('738', 'admin', '角色信息查看', 'SystemManage.RoleManage.controller.RoleController', '/role/manager', '', '0:0:0:0:0:0:0:1', '2020-02-20 11:35:54');
INSERT INTO `syslog` VALUES ('739', 'admin', '资源信息查看', 'SystemManage.ResourceManage.controller.ResourceController', '/resource/manager', '', '0:0:0:0:0:0:0:1', '2020-02-20 11:35:56');
INSERT INTO `syslog` VALUES ('740', 'admin', '客户流失添加', 'SystemManage.Customer.controller.CustomerLossController', '/customerLoss/add', 'null', '0:0:0:0:0:0:0:1', '2020-02-20 11:38:41');
INSERT INTO `syslog` VALUES ('741', 'admin', '客户流失管理', 'SystemManage.Customer.controller.CustomerLossController', '/customerLoss/manager', '', '0:0:0:0:0:0:0:1', '2020-02-20 11:38:59');
INSERT INTO `syslog` VALUES ('742', 'admin', '客户信息列表', 'SystemManage.Customer.controller.CustomerController', '/customer/manager', '', '0:0:0:0:0:0:0:1', '2020-02-20 11:39:23');
INSERT INTO `syslog` VALUES ('743', 'admin', '客户信息列表', 'SystemManage.Customer.controller.CustomerController', '/customer/manager', '', '0:0:0:0:0:0:0:1', '2020-02-20 11:42:13');
INSERT INTO `syslog` VALUES ('744', 'admin', '客户流失管理', 'SystemManage.Customer.controller.CustomerLossController', '/customerLoss/manager', '', '0:0:0:0:0:0:0:1', '2020-02-20 11:42:17');
INSERT INTO `syslog` VALUES ('745', 'admin', '客户信息列表', 'SystemManage.Customer.controller.CustomerController', '/customer/manager', '', '0:0:0:0:0:0:0:1', '2020-02-20 11:45:37');
INSERT INTO `syslog` VALUES ('746', 'admin', '客户流失管理', 'SystemManage.Customer.controller.CustomerLossController', '/customerLoss/manager', '', '0:0:0:0:0:0:0:1', '2020-02-20 11:45:37');
INSERT INTO `syslog` VALUES ('747', 'admin', '客户流失添加', 'SystemManage.Customer.controller.CustomerLossController', '/customerLoss/add', 'null', '0:0:0:0:0:0:0:1', '2020-02-20 11:46:50');
INSERT INTO `syslog` VALUES ('748', 'admin', '客户流失管理', 'SystemManage.Customer.controller.CustomerLossController', '/customerLoss/manager', '', '0:0:0:0:0:0:0:1', '2020-02-20 11:49:10');
INSERT INTO `syslog` VALUES ('749', 'admin', '客户信息列表', 'SystemManage.Customer.controller.CustomerController', '/customer/manager', '', '0:0:0:0:0:0:0:1', '2020-02-20 11:49:10');
INSERT INTO `syslog` VALUES ('750', 'admin', '客户信息列表', 'SystemManage.Customer.controller.CustomerController', '/customer/manager', '', '0:0:0:0:0:0:0:1', '2020-02-20 11:53:10');
INSERT INTO `syslog` VALUES ('751', 'admin', '客户流失管理', 'SystemManage.Customer.controller.CustomerLossController', '/customerLoss/manager', '', '0:0:0:0:0:0:0:1', '2020-02-20 11:53:10');
INSERT INTO `syslog` VALUES ('752', 'admin', '客户流失添加', 'SystemManage.Customer.controller.CustomerLossController', '/customerLoss/add', 'null', '0:0:0:0:0:0:0:1', '2020-02-20 11:53:13');
INSERT INTO `syslog` VALUES ('753', 'admin', '客户流失管理', 'SystemManage.Customer.controller.CustomerLossController', '/customerLoss/manager', '', '0:0:0:0:0:0:0:1', '2020-02-20 11:53:19');
INSERT INTO `syslog` VALUES ('754', 'admin', '客户流失添加', 'SystemManage.Customer.controller.CustomerLossController', '/customerLoss/add', 'null', '0:0:0:0:0:0:0:1', '2020-02-20 11:53:54');
INSERT INTO `syslog` VALUES ('755', 'admin', '客户流失管理', 'SystemManage.Customer.controller.CustomerLossController', '/customerLoss/manager', '', '0:0:0:0:0:0:0:1', '2020-02-20 11:54:03');
INSERT INTO `syslog` VALUES ('756', 'admin', '客户流失管理', 'SystemManage.Customer.controller.CustomerLossController', '/customerLoss/manager', '', '0:0:0:0:0:0:0:1', '2020-02-20 11:55:12');
INSERT INTO `syslog` VALUES ('757', 'admin', '客户流失添加', 'SystemManage.Customer.controller.CustomerLossController', '/customerLoss/add', 'null', '0:0:0:0:0:0:0:1', '2020-02-20 11:55:14');
INSERT INTO `syslog` VALUES ('758', 'admin', '客户流失管理', 'SystemManage.Customer.controller.CustomerLossController', '/customerLoss/manager', '', '0:0:0:0:0:0:0:1', '2020-02-20 11:55:18');
INSERT INTO `syslog` VALUES ('759', 'admin', '客户流失管理', 'SystemManage.Customer.controller.CustomerLossController', '/customerLoss/manager', '', '0:0:0:0:0:0:0:1', '2020-02-20 11:56:22');
INSERT INTO `syslog` VALUES ('760', 'admin', '客户流失添加', 'SystemManage.Customer.controller.CustomerLossController', '/customerLoss/add', 'null', '0:0:0:0:0:0:0:1', '2020-02-20 11:56:24');
INSERT INTO `syslog` VALUES ('761', 'admin', '客户流失管理', 'SystemManage.Customer.controller.CustomerLossController', '/customerLoss/manager', '', '0:0:0:0:0:0:0:1', '2020-02-20 11:56:28');
INSERT INTO `syslog` VALUES ('762', '系统自动任务', '定时删除日志：46条', '', '', '', '', '2020-02-20 12:00:00');
INSERT INTO `syslog` VALUES ('763', 'admin', '客户信息列表', 'SystemManage.Customer.controller.CustomerController', '/customer/manager', '', '0:0:0:0:0:0:0:1', '2020-02-20 12:01:33');
INSERT INTO `syslog` VALUES ('764', 'admin', '客户流失添加', 'SystemManage.Customer.controller.CustomerLossController', '/customerLoss/add', 'null', '0:0:0:0:0:0:0:1', '2020-02-20 12:02:05');
INSERT INTO `syslog` VALUES ('765', 'admin', '客户流失管理', 'SystemManage.Customer.controller.CustomerLossController', '/customerLoss/manager', '', '0:0:0:0:0:0:0:1', '2020-02-20 12:02:10');
INSERT INTO `syslog` VALUES ('766', 'admin', '客户流失管理', 'SystemManage.Customer.controller.CustomerLossController', '/customerLoss/manager', '', '0:0:0:0:0:0:0:1', '2020-02-20 12:05:28');
INSERT INTO `syslog` VALUES ('767', 'admin', '客户信息列表', 'SystemManage.Customer.controller.CustomerController', '/customer/manager', '', '0:0:0:0:0:0:0:1', '2020-02-20 12:05:46');
INSERT INTO `syslog` VALUES ('768', 'admin', '客户信息列表', 'SystemManage.Customer.controller.CustomerController', '/customer/manager', '', '0:0:0:0:0:0:0:1', '2020-02-20 12:07:48');
...
CREATE TABLE `t_customer_contact` (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  KEY `FK_t_customer_contact` (`cusId`) USING BTREE,
...
CREATE TABLE `t_customer_linkman` (
  ...
  `phone` varchar(20) DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  KEY `FK_t_customer_linkman` (`cusId`) USING BTREE,
...
INSERT INTO `t_customer_loss` VALUES ('13', '2e432d6c-b3a6-47fa-9d1b-5a1f92cb8f05', '1111111', '111', '1998-02-03', '2002-03-06', '0', '222');
INSERT INTO `t_customer_loss` VALUES ('14', '45c64442-4601-4aab-9ba9-820c3f6e5b0a', '222222', '222222', null, null, '0', '222212');
INSERT INTO `t_customer_loss` VALUES ('15', 'fdea0943-fa00-4fbf-8eec-96400d0d6a67', '333', '', null, null, '0', '3333');
INSERT INTO `t_customer_loss` VALUES ('16', 'b7351880-de20-4967-8d66-6b80a68ccd19', '555', '', null, null, '0', '555');
INSERT INTO `t_customer_loss` VALUES ('17', 'a43c01ea-b26e-4e6a-a129-f07b17c38e84', '122121', '', null, null, '1', '1212');
INSERT INTO `t_customer_loss` VALUES ('18', '1c41c4eb-1bce-45a9-8274-b4336725ac77', '123456', '', null, null, '1', '123');
...
CREATE TABLE `t_customer_order` (
  ...
  `state` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  KEY `FK_t_customer_order` (`cusId`) USING BTREE,
...
CREATE TABLE `t_customer_reprieve` (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  KEY `FK_t_customer_reprieve` (`lossId`) USING BTREE,
...
CREATE TABLE `t_order_details` (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  KEY `FK_t_order_details` (`orderId`) USING BTREE,
...
CREATE TABLE `user` (
  ...
  `phone` varchar(20) DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='用户';
...
CREATE TABLE `user_role` (
  ...
  `role_id` bigint(19) NOT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=188 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='用户角色';
